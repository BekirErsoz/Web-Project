...
import { 
  Calendar, MapPin, Heart, ArrowLeft, 
  ...
  useEffect(() => {
    const fetchCategoryData = async () => {
      ...
      try {
        ...
        // Kategoriye ait etkinlikleri al
        const categoryEvents = await getEventsByCategory(categoryId);
        setEvents(categoryEvents);
        applyFilters(categoryEvents);
      } catch (error) {
        console.error('Kategori verilerini alma hatası:', error);
      } finally {
        setLoading(false);
      }
    };
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
            <div className="flex items-center">
              ...
              <h2 className="text-2xl font-semibold">
                {categoryName ? `${categoryName} Etkinlikleri` : 'Kategori Etkinlikleri'}
              </h2>
          ...
          {loading ? (
            ...
            <div className="bg-white p-10 rounded-xl shadow-sm text-center">
              ...
              <p className="text-gray-600 mb-6 max-w-md mx-auto">
                Bu kategoride gösterilecek etkinlik bulunmamaktadır. Filtreleri temizleyerek tekrar deneyebilirsiniz.
              </p>
              <button 
                onClick={() => {
                  setPriceRange('all');
